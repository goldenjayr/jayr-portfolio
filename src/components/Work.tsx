  ...
  return (
    <section id="work" className="mx-auto max-w-6xl scroll-mt-24 px-6 py-28 md:py-40">
      <SectionHeading
        ...
        lead="Thirteen projects, from a seven-service AI platform to a Python tool that fixes one specific bug everyone else ships. Open a case study for the decisions behind it, or open a live one and use it."
      />
